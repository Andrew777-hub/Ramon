...
const orleanProducts = [
  {
    ...
    img: tumba1,
    additionalImages: [tumba2, tumba3, tumba4, tumba5, tumba6, tumba7, tumba8, tumba9, tumba10, tumba11, tumba12,],
  ...
  },
  {
    ...
    name: 'Комод "Орлеан"',
    img: komod1,
    additionalImages: [komod2, komod3, komod4, komod5, komod6, komod7, komod8, komod9],
    category: 'Комоди',
    categoryRu: 'Dressers',
    features: [
      'Каркас: Метал',
